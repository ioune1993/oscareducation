...
from .cbgv import LessonStudentListView, LessonStudentUpdateView
...
urlpatterns = patterns('promotions.views',
    ...
    url(r'^lesson/(?P<lesson_pk>\d+)/student/(?P<pk>\d+)/update/$', LessonStudentUpdateView.as_view(), name='student_update'),
