...
urlpatterns = patterns('student.views',
    ...
    url(r'^skill/(?P<slug>[a-zA-Z0-9_-]+)/$', user_is_student(DetailView.as_view(model=Skill, slug_field="code", template_name="professor/skill/update_pedagogical_resources.haml")), name='student_skill_pedagogic_ressources'),
)
